...
class App {
	...
	public function predefined_colors () {
		return [
			'#2563EB','#1D4ED8','#3B82F6','#4F46E5','#4338CA','#6366F1',
			'#7C3AED','#6D28D9','#9333EA','#A21CAF','#C026D3','#DB2777',
			'#E11D48','#F43F5E','#DC2626','#EA580C','#F97316','#F59E0B',
			'#D97706','#CA8A04','#65A30D','#4D7C0F','#16A34A','#15803D',
			'#059669','#0D9488','#0891B2','#0284C7','#0369A1','#0284C7',
			'#0EA5E9','#2563EB'
		];
	}
}