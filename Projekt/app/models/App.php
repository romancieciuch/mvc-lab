...
class App {
	...
	public function predefined_colors () {
		return [
			'#7678ed', '#f18701', '#f35b04', '#fb5607', '#ff006e',
			'#8338ec', '#3a86ff', '#2b2d42', '#8d99ae', '#d90429',
			'#ff595e', '#2563EB', '#8ac926', '#1982c4', '#6a4c93',
			'#05668d', '#028090', '#00a896', '#02c39a', '#9b5de5',
			'#f15bb5', '#00bbf9', '#00f5d4', '#9e0059', '#ff0054',
			'#ff5400', '#ffbd00', '#f72585', '#b5179e', '#480ca8',
			'#4361ee', '#4895ef'
		];
	}
